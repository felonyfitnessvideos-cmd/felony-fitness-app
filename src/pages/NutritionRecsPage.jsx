...
function NutritionRecsPage() {
  ...
  const handleGenerateRecs = async () => {
    ...
    // This calls the nutrition-specific Supabase function
  ...
  return (
    // The main container is now a full-height flexbox frame
    <div className="nutrition-recs-container">
      ...
      {/* This new scroll area will contain all the content and handle overflow */}
