...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const prompt = [
      ...
      '1. Compare 7-day totals against weekly targets (daily goal × 7)',
      '2. For DEFICIENCIES: Recommend specific foods from the nutrition summary to increase',
      '3. For EXCESSES: Identify which foods from their nutrition summary are causing the excess and suggest healthier alternatives',
      '4. Pay special attention to: Sodium, Sugar, Cholesterol, Saturated Fat (common excess nutrients)',
      '5. For micronutrients (vitamins/minerals): Provide food-based solutions, not just supplement recommendations',
